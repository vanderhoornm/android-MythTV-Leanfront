package org.mythtv.leanfront.exoplayer2.extractor.mkv;
...
//import DefaultEbmlReader;
//import EbmlProcessor;
//import EbmlReader;
//import Sniffer;
//import VarintReader;
...
public class MatroskaExtractor implements Extractor {
    ...
    /* package */ MatroskaExtractor(EbmlReader reader, @MatroskaExtractor.Flags int flags) {
        this.reader = reader;
        this.reader.init(new MatroskaExtractor.InnerEbmlProcessor());
    ...
    protected void startMasterElement(int id, long contentPosition, long contentSize)
        ...
        switch (id) {
            ...
            case ID_CONTENT_ENCRYPTION:
                ...
                break;
            case ID_TRACK_ENTRY:
                currentTrack = new MatroskaExtractor.Track();
                break;
            case ID_MASTERING_METADATA:
    ...
    protected void endMasterElement(int id) throws ParserException {
        switch (id) {
            ...
            case ID_BLOCK_GROUP:
                ...
                MatroskaExtractor.Track track = tracks.get(blockTrackNumber);
                for (int i = 0; i < blockSampleCount; i++) {
    ...
    protected void handleBlockAdditionalData(
            MatroskaExtractor.Track track, int blockAdditionalId, ExtractorInput input, int contentSize)
            throws IOException {
    ...
    private void commitSampleToOutput(
            MatroskaExtractor.Track track, long timeUs, @C.BufferFlags int flags, int size, int offset) {
     ...
     */
    private int writeSampleData(ExtractorInput input, MatroskaExtractor.Track track, int size) throws IOException {
    ...
    /**
     * Called by {@link #writeSampleData(ExtractorInput, MatroskaExtractor.Track, int)} when the sample has been
    ...
    /** Resets state used by {@link #writeSampleData(ExtractorInput, MatroskaExtractor.Track, int)}. */
    ...
    private static final class Track {
        ...
        @Nullable public MatroskaExtractor.TrueHdSampleRechunker trueHdSampleRechunker;
        ...
        public void initializeOutput(ExtractorOutput output, int trackId) throws ParserException {
            ...
            if (MimeTypes.isAudio(mimeType)) {
                ...
                if (displayUnit == MatroskaExtractor.Track.DISPLAY_UNIT_PIXELS) {
